      ...
      <div className="container mx-auto">
        ...
        <Slider {...settings}>
          <div className="card w-96  shadow-xl cursor-pointer">
            <figure>
              <img src={person1} alt="person" className="rounded-xl" />
            </figure>
            <div className=" flex justify-around mt-8  items-center text-center">
              <div>
                ...
                <p className="text-white text-xl">Web Designer</p>
              </div>
              <div>
          ...
          <div className="card w-96 cursor-pointer ">
            <figure>
              <img src={person2} alt="person" className="rounded-xl" />
            </figure>
            <div className=" flex justify-around mt-8  items-center text-center">
              <div>
                <h2 className="card-title text-2xl text-white mb-2">
          ...
          <div className="card w-96 cursor-pointer ">
            <figure>
              <img src={person3} alt="person" className="rounded-xl" />
            </figure>
            <div className=" flex justify-around mt-8  items-center text-center">
              <div>
                <h2 className="card-title text-2xl text-white mb-2">
          ...
          <div className="card w-96 cursor-pointer ">
            <figure>
              <img src={person4} alt="person" className="rounded-xl" />
            </figure>
            <div className=" flex justify-around mt-8  items-center text-center">
              <div>
                <h2 className="card-title text-2xl text-white mb-2">
                ...
                <p className="text-white text-xl">Project Manager</p>
              </div>
              <div>
                <FiArrowUpRight size={30} />
              </div>
          ...
          <div className="card w-96 cursor-pointer ">
            <figure>
              <img src={person5} alt="person" className="rounded-xl" />
            </figure>
            <div className=" flex justify-around mt-8  items-center text-center">
              <div>
                <h2 className="card-title text-2xl text-white mb-2">
                ...
                <p className="text-white text-xl">Data Analyzer</p>
              </div>
              <div>
                <FiArrowUpRight size={30} />
              </div>
