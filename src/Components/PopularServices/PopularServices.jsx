...
const PopularServices = () => {
  return (
    <div className="container mx-auto">
      ...
      <h1 className=" lg:text-7xl text-xl font-design font-bold italic text-center text-white py-6">
        We Provide Amazing Web <br />
        <span className=" text-emerald-500">Design</span> Solutions
      </h1>

      {/* Cards Here  */}
      <div className="lg:flex w-10/12 mx-auto  lg:flex-row justify-between items-center gap-6 flex-col py-14">
        <div className="card card-side w-11/12 lg:w-full   mb-10 lg:mb-0 mx-auto bg-[#0A1019] shadow-xl  lg:h-[500px] h-full hover:shadow-2xl hover:shadow-emerald-400 cursor-pointer">
